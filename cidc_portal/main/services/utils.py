    ...
    if "jwt_token" in session:
        ...
        if session["cidc_user_info"] is not None:
            return dict(
                ...
                browse_files_url=url_for_with_prefix("/cimac_biofx/browse-files"),
                wes_pipelines_url=url_for_with_prefix("/cimac_biofx/wes-pipeline"),
                wes_upload_instructions_url=url_for_with_prefix("/cimac_biofx/wes-upload"),
